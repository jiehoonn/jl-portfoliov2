...
export default function Contact() {
  const contactLinks = [
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/jiehoonlee2002/', 
      icon: (
        <svg 
          width="40" 
          height="40" 
  ...
  return (
    <section className="px-6 py-16 pb-32 lg:px-20 lg:py-24 lg:pb-40 min-h-screen flex items-center">
